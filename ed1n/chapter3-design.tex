...
The mapper builds a histogram of all words in each input record before
emitting key-value pairs corresponding to unique words observed.
\begin{small}
\begin{Verbatim}[numbers=left, xleftmargin=7.5mm]
class Mapper {
  def map(key: Long, value: Text) = {
...
The mapper builds a histogram of all input records processed before
emitting key-value pairs corresponding to unique words observed.
\begin{small}
\begin{Verbatim}[numbers=left, xleftmargin=7.5mm]
class Mapper {
...
Mapper is the identify function; the mean is computed in the reducer.
\begin{small}
\begin{Verbatim}[numbers=left, xleftmargin=7.5mm]
class Mapper {
...
With ``pairs'', each co-occurring pair of words is tracked separately.
\begin{small}
\begin{Verbatim}[numbers=left, xleftmargin=7.5mm]
class Mapper {
  def map(key: Long, value: Text) = {
...
With ``stripes'', all words co-occurring with a word are tracked
together.
\begin{small}
\begin{Verbatim}[numbers=left, xleftmargin=7.5mm]
class Mapper {
