...
% Note: what about reduce-side join when L gets too big?
% Key idea, partition L side, replicate R for each
% Similar to SKEWED JOIN in Pig, see Gates et al. paper in
