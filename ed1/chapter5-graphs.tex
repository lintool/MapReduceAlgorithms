...
discussed in the chapter introduction involve {\it sparse} graphs,
where the number of {\it actual} edges is far smaller than the number
of {\it possible} edges.\footnote{Unfortunately, there is no precise
...
from {\it CLR}).  We start out in (a) with $n_1$ having a
